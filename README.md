...
* Cheater Banlist
  * no way to my knowledge to uniquely identify a player since you cant access playfab online ids, and names can be easly changed.
* Friend Leaderboard Fix
  * simply couldn't be bothered
* Open Ghost Directory
  * Won't work as paths are virtualized or something like that idfk

## Installation & Usage

1. Download [MelonLoader](https://github.com/LavaGang/MelonLoader/releases/latest) zip version and unpack in your XboxGames Neon White Content folder (e.g. `C:\XboxGames\Neon White\Content`)
